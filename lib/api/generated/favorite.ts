...
import type { Prisma, Favorite } from "../../../generated/prisma-client";
...
export function useCheckFavorite<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; userId?: string; placeId?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
